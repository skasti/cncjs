...
const IconButton = styled(Button)`
    ...
    min-width: 46px; // 8px + 30px + 8px
    height: 46px; // 8px + 30px + 8px
                            ...
                            <ButtonToolbar>
                                <ButtonGroup btnSize="m">
                                    ...
                                    >
                                        <Tooltip
                                            ...
                                            hideOnClick
                                        >
                                            <Image src={iconTopView} width="30" height="30" />
                                        </Tooltip>
                                    </IconButton>
                                    <IconButton
                                        className={cx({
                                    ...
                                    >
                                        <Tooltip
                                            ...
                                            hideOnClick
                                        >
                                            <Image src={iconFrontView} width="30" height="30" />
                                        </Tooltip>
                                    </IconButton>
                                    <IconButton
                                        className={cx({
                                    ...
                                    >
                                        <Tooltip
                                            ...
                                            hideOnClick
                                        >
                                            <Image src={iconRightSideView} width="30" height="30" />
                                        </Tooltip>
                                    </IconButton>
                                    <IconButton
                                        className={cx({
                                    ...
                                    >
                                        <Tooltip
                                            ...
                                            hideOnClick
                                        >
                                            <Image src={iconLeftSideView} width="30" height="30" />
                                        </Tooltip>
                                    </IconButton>
                                    <IconButton
                                        className={cx({
                                    ...
                                    >
                                        <Tooltip
                                            ...
                                            hideOnClick
                                        >
                                            <Image src={icon3DView} width="30" height="30" />
                                        </Tooltip>
                                    </IconButton>
                                    <Repeatable
                                    ...
                                    >
                                        <Tooltip
                                            ...
                                            hideOnClick
                                        >
                                            <Image src={iconZoomFit} width="30" height="30" />
                                        </Tooltip>
                                    </Repeatable>
                                    <Repeatable
                                        componentClass={IconButton}
                                    ...
                                    >
                                        <Tooltip
                                            ...
                                            hideOnClick
                                        >
                                            <Image src={iconZoomIn} width="30" height="30" />
                                        </Tooltip>
                                    </Repeatable>
                                    <Repeatable
                                        componentClass={IconButton}
                                    ...
                                    >
                                        <Tooltip
                                            ...
                                            hideOnClick
                                        >
                                            <Image src={iconZoomOut} width="30" height="30" />
                                        </Tooltip>
                                    </Repeatable>
                                </ButtonGroup>
                                <Dropdown
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Image src={iconMoveCamera} width="30" height="30" />
                                        }
                                        {(cameraMode === CAMERA_MODE_ROTATE) &&
                                        <Image src={iconRotateCamera} width="30" height="30" />
                                        }
                                    </Dropdown.Toggle>
                                    <Dropdown.Menu>
